...
define('emmet/utils/common', function() {
	return emmet.require('modules/common');
});

define('emmet/utils/action', function() {
	return emmet.require('modules/action');
});
 ...
 */
define('editor',['emmet/modules/common', 'emmet/modules/action', 'emmet/assets/resources', 'emmet/assets/tabStops'], function(utils, actionUtils, res, tabStops) {
	/**
