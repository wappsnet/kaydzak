		...
		if( $visibility ) {
			...
			if( $field_group['label_placement'] == 'left' ) {
				...
				<table class="acf-table">
					<tbody>
						<?php acf_render_fields( $fields, $this->post_id, 'tr', $field_group['instruction_placement'] ); ?>
					</tbody>
				</table>
				<?php
		...
		if( !empty($field_groups) ) {
			...
			foreach( $field_groups as $field_group ) {
				...
				if( $field_group['label_placement'] == 'left' ) {
					...
					<table class="acf-table">
						<tbody>
							<?php acf_render_fields( $fields, $options['post_id'], 'tr', $field_group['instruction_placement'] ); ?>
						</tbody>
					</table>
					<?php
