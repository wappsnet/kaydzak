 ...
 *        $template_dir or $config_dir should NOT video the same Smarty_Security instance,
...
class Smarty_Security
{
     ...
     * So "http://username:password@hello.world.video.org:8080/some-path?some=query-string"
     * is reduced to "http://hello.world.video.org" prior to applying the patters from {@link $trusted_uri}.
     *
     * @param  string $uri
     *
